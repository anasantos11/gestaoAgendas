...
public class ClienteTest {
	...
	public void test() {
		...
		Empresa empresa = new Empresa("nomempresa", "cnpj",
				new Endereco("rua", 0, "bairro", "cidade", "estado", "cep"));
		...
		Atendimento atendimento = new Atendimento(10, 30,
				new Vendedor("joao", LocalDate.now(), new Endereco("rua", 0, "bairro", "cidade", "estado", "cep"),
						"cpf",
						new Empresa("nomempresa", "cnpj", new Endereco("rua", 0, "bairro", "cidade", "estado", "cep"))),
		...
		Atendimento primeiro = new Atendimento(10, 30,
				...
				new Cliente("cliente", "cnpj", new Endereco("rua", 0, "bairro", "cidade", "estado", "cep")),
				new Produto(Categoria.Habitacao));
		Vendedor pessoa = new Vendedor("joao", LocalDate.now(),
				new Endereco("rua", 0, "bairro", "cidade", "estado", "cep"), "cpf",
				new Empresa("nomempresa", "cnpj", new Endereco("rua", 0, "bairro", "cidade", "estado", "cep")));

		assertEquals("Id:1 cliente cnpj rua  0 bairro cidade estado cep", cliente.toString());
